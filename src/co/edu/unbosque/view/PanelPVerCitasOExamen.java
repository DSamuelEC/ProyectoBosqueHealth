...
//	private JLabel lblHora;
	...
	public void inicializarComponentes() {
		DefaultTableModel modeloTabla = new DefaultTableModel(
				new Object[] { "Nombre Especialista", "Fecha", "Hora Inicio", "Hora Final" }, 0);
...
//		add(lblNombreEspecialista);
	 ...
	 */
	public void agregarFilaTabla(String especialista, String fecha, String horaInicio, String horaFinal) {
		DefaultTableModel modeloTabla = (DefaultTableModel) tblVerCitasOExamen.getModel();
		modeloTabla.addRow(new Object[] { especialista, fecha, horaInicio, horaFinal });
	}
